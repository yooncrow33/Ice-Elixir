...
import ie.main.object.entity.bullet.PlayerBullet;
import ie.main.object.entity.player.Player;

public class Gun {
    final int maxDistance = 600;
    final int spendElixir = 5;
    final double bulletSpeed = 15;
    final int bulletSize = 30;
    final int damage = 20;
    final Main main;
    final Player player;
    ...
    public void shot() {
        ...
        main.addGameEntity(new Fire(bulletSize,player.getX(),player.getY(),-20,player.getOrbit().getAngle(),bulletSpeed,distance,damage,main.getEnemies()));
